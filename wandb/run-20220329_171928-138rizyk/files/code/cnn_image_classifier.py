...
if __name__ == "__main__":
    ...
    CONFIG = wandb.config
    wandb.run.name = "CNN2_" + str(CONFIG.num_filters) + "_dn_" + str(CONFIG.dense_neurons) + "_opt_" + CONFIG.optimiser + "_dro_" + str(CONFIG.dropout) + "_bs_" + str(CONFIG.batch_size) + "_fd_" + str(CONFIG.num_filters)
